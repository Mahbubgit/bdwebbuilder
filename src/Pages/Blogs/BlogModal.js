        ...
        <div>
            ...
            <div className="modal" role="dialog">
                <div className="modal-box">
                    ...
                    <p className='text-end'><small>{bloggerName}</small><small className='ps-2'>{postingDate}</small></p>
                    <p className='text-justify mt-2'>{description}</p>
                    <div className='text-end'>
                        <label htmlFor="blog-modal" className="btn btn-sm mt-3 text-white font-bold btn-outline btn-accent">Close</label>
                    </div>
                </div>
            </div>
        </div>
